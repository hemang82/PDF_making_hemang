...
export default function WebViewer({ heading, buttonLabel, accept, multiple, isCheckPdfPasswordProtected, filesLimit, maxFileSizePerTaskInBytes, fileNameAddOn, tool, toolName }) {
    ...
    return (<>
        <div className='flex'>
            ...
            <div className="webviewer" ref={viewer} style={{ height: "calc(100vh - 152px)", width: "calc(100% - 420px)", background: "#ffffff" }}> </div>
