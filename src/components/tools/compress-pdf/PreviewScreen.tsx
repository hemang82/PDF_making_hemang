...
import SidebarContent from '@/components/tools/compress-pdf/SidebarContent';
    ...
    try {
      const response = await fetch('/api/ilovepdf/process', {
        ...
        body: JSON.stringify({
          ...
          tool,
          files: filePayload,
          compression_level: selectedCompressionLevel,
        }),
      });
      ...
      <div className='flex h-full'>
        ...
        >
          <SidebarContent
            ...
            onCompressionLevelChange={setSelectedCompressionLevel}
          />
        </ActionSidebar>
      </div>
