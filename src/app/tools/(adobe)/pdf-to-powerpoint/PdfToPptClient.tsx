...
const UPLOAD_SCREEN_PROPS = Object.freeze({
  ...
  description: 'Transform your PDF into an editable PowerPoint presentation while preserving formatting.',
...
/*---------------------------------------------------------------
                      PDF to PowerPoint Client Component
---------------------------------------------------------------*/
const PdfToPptClient = (): JSX.Element => {
