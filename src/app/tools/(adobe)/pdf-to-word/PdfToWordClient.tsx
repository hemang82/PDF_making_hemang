...
const UPLOAD_SCREEN_PROPS = Object.freeze({
  ...
  description: 'Transform your PDF into an editable Word document while preserving formatting.',
...
/*---------------------------------------------------------------
                      PDF to Word Client Component
---------------------------------------------------------------*/
const PdfToWordClient = (): JSX.Element => {
...
export default PdfToWordClient;
